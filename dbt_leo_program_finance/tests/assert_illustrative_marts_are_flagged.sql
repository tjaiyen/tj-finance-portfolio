...
select 'mart_eac_sensitivity' as mart_name, count(*) as unflagged_rows
from {{ ref('mart_eac_sensitivity') }}
where is_illustrative is distinct from true
having count(*) > 0

union all

select 'mart_90day_roadmap' as mart_name, count(*) as unflagged_rows
